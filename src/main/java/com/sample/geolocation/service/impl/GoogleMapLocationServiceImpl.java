...
public class GoogleMapLocationServiceImpl implements GeolocationService {
    ...
    public Result getLatLongByCity(String city) {
        // implement the logic of how to process the details, preparing the data model and calling the google map API
        // For demonstration sake we will pass back a dummy response

        logger.info("Using Google Map Service implementation");

        return new Result("40.714224","-73.96145");
    }
}
